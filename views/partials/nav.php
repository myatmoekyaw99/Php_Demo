<nav class="bg-gray-800">
            ...
            <?php if($_SESSION['user'] ?? false) :?>
              <div class="ml-3">
                <form action="/session" method="POST">
                  ...
                  <button type="submit" class="<?= isUrl('/session') ? 'bg-gray-900 text-white' : 'text-gray-300'?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Logout</button>
    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <a href="/" class="text-gray-300 hover:bg-gray-700 text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Dashboard</a>
        <a href="/about.php" class="text-gray-300 hover:bg-gray-700 text-white block rounded-md px-3 py-2 text-base font-medium">About</a>
        <a href="/contact.php" class="text-gray-300 hover:bg-gray-700 text-white block rounded-md px-3 py-2 text-base font-medium">Contact</a>
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">TomCook</div>
